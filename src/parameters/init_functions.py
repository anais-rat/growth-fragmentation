...
def generate_initial_condition(parameters, format_choice, dxs_to_normalize=None):
    ...
    def initial_condition(sizes, features):
        ...
        -------
        n_init : ndarray
            2D array (v_count, x_count) describing the initial distribution.
...
def geometrical_grid(point_count, k):
    ...
    if point_count % 2 == 0:  # Verification of arguments format.
        print(
            "Warning: even number of points given in argument to `geometric"
