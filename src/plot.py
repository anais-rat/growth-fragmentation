...
from src.write_path import FOLDER_FIG, FOLDER_VID, remove_special_caraters
...
LABELS = {'y_beta': r'Fragmentation rate per unit of size $\beta$',
          ...
          'y_n_tdiff':
              r"Approximation of $\frac{\textrm{d}}{\textrm{d} t} "
        ...
        for time_idx in range(time_count):
            ...
            if os.path.exists(path):
                ...
                fig, axes = plt.subplots(
                    2, 1, sharex=False, sharey=False, figsize=(W, H),
